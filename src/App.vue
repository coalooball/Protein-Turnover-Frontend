    ...
    <q-layout view="lHh lpR fFf">
        ...
        <q-header elevated class="bg-dark text-white" height-hint="98">
            ...
            <q-tabs align="left">
                ...
                <q-route-tab to="/protein_turnover/jobs" label="Jobs" no-caps />
        ...
        <q-drawer show-if-above v-model="leftDrawerOpen" side="left" bordered class="text-white" :class="$q.dark.isActive ? 'bg-grey-10' : 'bg-grey-10'">
...
watch(
    ...
    (newPath) => {
        if (newPath === "/protein_turnover") {
            title.value =
                "View the basic status and operating environment of the host.";
            sidebarFlag.value = 0;
        } else if (newPath === "/protein_turnover/preparation") {
            title.value = "Preparation.";
            sidebarFlag.value = 1;
        } else if (newPath === "/protein_turnover/jobs") {
